// Story:
// Alex is a great fan of Snooker and he likes recording the results of his favorite players by
// recording the balls that fall into the pockets of the table. He asks you to help him with a program
// that calculates the points a player scored in a given set using his notes.
...
// The color may be followed by a number 'R12' would stand for 12 red balls pocketed. If there is no
// number given, the ball was pocketed once.
...
// For your convenience the points for each color are provided as hash / dictionary with the name
// 'blz'.
...
function frame(balls){
  ...
  console.log(tuples)
  let pointsEarned = tuples.map((pair,idx) => {
    if (pair.length > 1) {
