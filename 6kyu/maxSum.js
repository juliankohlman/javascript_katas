// Given an array arr that contains some integers(positive,  negative or 0), and a range list such
// as [[start1,end1],[start2,end2],...], start and end are the index of arr and start always less
// than end. Your task is to calculate the sum value of each range (start index and end index are
...
function maxSum(arr, range) {
  return Math.max(...range.map(r => arr.slice(r[0], r[1] + 1).reduce((a, b) => a + b)));
}
