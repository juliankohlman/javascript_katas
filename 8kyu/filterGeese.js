...
// Swedish"] Your function would return the following array:

// ["Mallard", "Hook Bill", "Crested", "Blue Swedish"] The elements in the
...
const birds = ['Mallard', 'Barbary', 'Hook Bill', 'Blue Swedish', 'Crested', 'African', 'Roman Tufted', 'Toulouse', 'Pilgrim', 'Steinbacher'];

function gooseFilter(input) {
  const geese = ['African', 'Roman Tufted', 'Toulouse', 'Pilgrim', 'Steinbacher'];
  return input.filter(item => !geese.includes(item));
}
